			...
			<div class="main-content">
				...
				<section class="posts-con">
					...
					<div>
						...
						echo $text;?></p>
						<a href="profile.php?content=<?php echo "viewdetail.php&id=".$data['id']; ?>" class="btn btn-primary">View Detail</a><br /> <br />
					</div>
					...
					<?php
						if($id>1) //kalo idnya lebih dari 1 bakal ada tombol previous
						{
							?>
							<br /><br />
							<a href="profile.php?content=<?php echo "infoadmin.php&id=".($id-1); ?>" class="btn btn-primary">PREVIOUS</a><br /><br />
						<?php
						}
						if($id!=$total) // selama idnya ga sama dengan total semua baris tampilin tombol next
						{
							?>
							<a href="profile.php?content=<?php echo "infoadmin.php&id=".($id+1); ?>" class="btn btn-primary">NEXT</a><br> <br>
						...
						for($i=1;$i<=$total;$i++) //ngelooping banyaknya page
						{
							if($i==$id) { echo "<li class='btn btn-primary'><h4>".$i."</h4></li> &nbsp"; }
								...
								<li class="btn btn-primary"><a href="profile.php?content=<?php echo "infoadmin.php&id=".$i; ?>"><h4><?php echo "$i"?></h4></a></li> &nbsp
								<?php
								}
								}	
					?>
